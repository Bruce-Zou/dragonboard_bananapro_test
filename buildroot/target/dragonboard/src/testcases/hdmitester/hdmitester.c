...
static int init_layer(void)
{
    ...
    fb_para.fb_mode = 4; //FB_MODE_SCREEN1;
...
int main(int argc, char *argv[])
{
	...
	while (1) {
		...
		if((DISP_OUTPUT_TYPE_NONE != disp_output_type)
			&& (DISP_OUTPUT_TYPE_HDMI != disp_output_type) && (DISP_OUTPUT_TYPE_TV != disp_output_type))
		{
...
//				db_warn("hdmitester:status is 1!\n");
				if(disp_output_type == DISP_OUTPUT_TYPE_NONE || DISP_OUTPUT_TYPE_TV){
				    args[0] = 0;
